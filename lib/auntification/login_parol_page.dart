            ...
            new Row(
              children: [
                new RaisedButton(onPressed: (){
                  if(_formkey.currentState.validate()) Scaffold.of(context).showSnackBar(SnackBar(content:
                  Text('вы успешно вошли в аккаунт'), backgroundColor: Colors.green,));
                  Navigator.push(context, MaterialPageRoute(builder: (context) => MyChattingPage()));
                }, child: Text('Войти'), color: Colors.deepPurple, textColor: Colors.white,
                )
              ],
            )
          ],
